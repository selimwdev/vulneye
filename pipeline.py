...
SCANNERS = [
    ...
    {"name": "DNS Scanner", "port": 5003, "any_port": False, "target_ports": [53]},
    {"name": "FTP Scanner", "port": 5004, "any_port": False, "target_ports": [21]},
    {"name": "IMAP Scanner", "port": 5005, "any_port": False, "target_ports": [143, 993]},
    {"name": "Network Discovery", "port": 5006, "any_port": True},
    {"name": "Ping Scanner", "port": 5007, "any_port": True},
    {"name": "Port Scanner", "port": 5008, "any_port": False},
    {"name": "RDP Scanner", "port": 5009, "any_port": False, "target_ports": [3389]},
    {"name": "Service Scanner", "port": 5010, "any_port": True},
    {"name": "SMB Scanner", "port": 5011, "any_port": False, "target_ports": [139, 445]},
    {"name": "SMTP Scanner", "port": 5012, "any_port": False, "target_ports": [25, 587, 465]},
    {"name": "SSH Scanner", "port": 5013, "any_port": False, "target_ports": [22]},
    {"name": "TCP Scanner", "port": 5014, "any_port": False, "target_ports": [111]},
    {"name": "Telnet Scanner", "port": 5015, "any_port": False, "target_ports": [23]},
    {"name": "TLS/SSL Scanner", "port": 5016, "any_port": True},
    {"name": "Web Scanner", "port": 5017, "any_port": False, "target_ports": [80, 443, 8080]},
]
